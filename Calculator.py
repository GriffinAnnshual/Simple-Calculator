from tkinter import Tk, Entry, Label, Button, END, font
...
def create_window():
    ...
    label = Label(window2, text="THANKS FOR USING \n MY CALCULATOR",
                  ...
                  fg='IndianRed2', bg='pale green')
    label.place()
    label.pack()
    label2 = Label(window2, text="Purely programmed using python by s Griffin Annshual",
                   font=('Comic Sans MS', 10),
                   fg='IndianRed2', bg='pale green')
    label2.place(x=10, y=75)
    label2 = Label(window2, text="Please send your Feedbacks @Whatsapp-8903396562",
                   font=('Comic Sans MS', 10),
                   fg='IndianRed2', bg='pale green')
...
c = Button(window, text='CLEAR', font=myFont, width=12, command=lambda: btclick('CLEAR'),
           bg='green yellow')
c.place(x=270, y=300)

c = Button(window, font=myFont, text='Ans', width=12, command=lambda: btclick('Ans'),
           bg='green yellow')
c.place(x=140, y=350)

c = Button(window, font=myFont, text='Click Me!', width=12,
           command=lambda: [create_window(), window.destroy()],
           bg='tomato', fg='white')
c.place(x=270, y=350)
